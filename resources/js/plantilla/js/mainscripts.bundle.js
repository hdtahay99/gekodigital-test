...
function CustomJs() { $(".light_dark input").on("change", function() { "dark" == $(this).val() ? $("body").addClass("theme-dark") : $("body").removeClass("theme-dark") }), $(".boxs-close").on("click", function() { $(this).parents(".card").addClass("closed").fadeOut() }), $(".list_btn").on("click", function() { $(".chat_list").toggleClass("open") }) }
